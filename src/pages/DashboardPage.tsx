  ...
  return (
    <Box className="animate-fade-in-up" sx={{ pb: 6 }}>
      ...
      {upcomingMeeting ? (
        ...
        >
          {/* Subtle animated gradient background for Zen vibe */}
          <Box
            sx={{
              position: 'absolute',
              top: 0,
              ...
              bottom: 0,
              background: isDarkMode
                ? 'linear-gradient(120deg, rgba(16,185,129,0.03) 0%, rgba(255,127,17,0.02) 100%)'
                : 'linear-gradient(120deg, rgba(16,185,129,0.05) 0%, rgba(255,127,17,0.03) 100%)',
              zIndex: 0,
            }}
          />
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2.2, zIndex: 1 }}>
            <Box
              sx={{
                ...
                borderRadius: '16px',
                background: isDarkMode 
                  ? 'radial-gradient(circle, rgba(16,185,129,0.12) 0%, rgba(16,185,129,0.02) 100%)' 
                  : 'radial-gradient(circle, rgba(16,185,129,0.08) 0%, rgba(16,185,129,0.02) 100%)',
                border: `1px solid ${isDarkMode ? 'rgba(16,185,129,0.2)' : 'rgba(16,185,129,0.12)'}`,
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                color: '#10B981',
            ...
            >
              <LocalCafeOutlinedIcon sx={{ fontSize: 26 }} />
            </Box>
            <Box>
              <Typography 
                variant="h6" 
