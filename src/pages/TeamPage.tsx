...
const ShiftTimePicker = ({ label, value, onChange, isDarkMode }: ShiftTimePickerProps) => {
  ...
  // Scroll ONCE when popover opens
  useEffect(() => {
    if (open) {
  ...
  return (
    <>
      ...
      >
        ...
        <AccessTimeIcon sx={{ fontSize: 18, color: open ? primaryColor : 'text.disabled' }} />
      </Box>
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.8, mb: 1.5 }}>
          ...
          <Box
            ...
            sx={{
              ...
              '&:hover': { opacity: 0.85 }, userSelect: 'none',
            }}
          >
            {period}
          </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1, alignItems: 'flex-start' }}>
          {/* Hour column */}
          <Box sx={{ flex: 1 }}>
            <Typography sx={{ textAlign: 'center', fontSize: '0.65rem', fontWeight: 700, color: 'text.disabled', mb: 0.5, textTransform: 'uppercase', letterSpacing: '0.08em' }}>HR</Typography>
            <div
              ref={hourRef}
              style={{
                display: 'flex', flexDirection: 'column', alignItems: 'center',
                height: 160, overflowY: 'auto', padding: '0 4px',
                scrollbarWidth: 'none',
              }}
            >
              {hours.map((h) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => setHour(h)}
                    style={{
                      minHeight: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <Typography sx={{ alignSelf: 'center', fontWeight: 800, fontSize: '1.1rem', color: isDarkMode ? 'rgba(255,255,255,0.15)' : 'rgba(0,0,0,0.12)', mt: 2 }}>:</Typography>

          {/* Minute column */}
          <Box sx={{ flex: 1 }}>
            <Typography sx={{ textAlign: 'center', fontSize: '0.65rem', fontWeight: 700, color: 'text.disabled', mb: 0.5, textTransform: 'uppercase', letterSpacing: '0.08em' }}>MIN</Typography>
            <div
              ref={minRef}
              style={{
                display: 'flex', flexDirection: 'column', alignItems: 'center',
          ...
          {/* Period column */}
          <Box sx={{ flex: 1 }}>
            <Typography sx={{ textAlign: 'center', fontSize: '0.65rem', fontWeight: 700, color: 'text.disabled', mb: 0.5, textTransform: 'uppercase', letterSpacing: '0.08em' }}>PERIOD</Typography>
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0.75, mt: 1.5 }}>
              {['AM', 'PM'].map((p) => (
                <Box
                  ...
                  onClick={() => setPeriod(p)}
                  sx={{
                    px: 2, py: 0.8, borderRadius: '12px', cursor: 'pointer',
                    fontWeight: p === period ? 700 : 400, fontSize: '0.88rem',
                    bgcolor: p === period ? primaryColor : isDarkMode ? 'rgba(255,255,255,0.05)' : 'rgba(93,26,137,0.06)',
                    color: p === period ? '#fff' : isDarkMode ? 'rgba(255,255,255,0.45)' : 'rgba(93,26,137,0.5)',
                    border: `1.5px solid ${p === period ? primaryColor : 'transparent'}`,
                    transition: 'all 0.1s', '&:hover': { opacity: 0.85 }, userSelect: 'none',
                  }}
                >
                  {p}
                </Box>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 1.5 }}>
          <Box
            ...
            sx={{
              ...
              '&:hover': { opacity: 0.88 }, userSelect: 'none',
            }}
          >
            Done
          </Box>
